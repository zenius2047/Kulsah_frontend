...
import { DP_HEIGHT, DP_WIDTH, PHONE_TYPE } from '../utils/device';

const initialScreen = { height: DP_HEIGHT, width: DP_WIDTH };
  ...
  subscribeWithSelector(
    persist(
      (set) => ({
        ...
        mediumScreen: PHONE_TYPE !== 'small',
        smallWidth: PHONE_TYPE === 'small',
