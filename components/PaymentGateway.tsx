...
const createStyles = (isDark: boolean, theme: ReturnType<typeof useThemeMode>['theme']) => {
  ...
  return StyleSheet.create({
    ...
    headerCopy: { flex: 1 },
    title: { color: text, ...fontSize.b3, lineHeight: fontSize.b3.fontSize + 2, textTransform: 'uppercase' },
    subtitle: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.4, marginTop: 3 },
    ...
    summaryCopy: { flex: 1 },
    summaryLabel: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.3 },
    summaryValue: { color: text, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', marginTop: 4 },
    amountBlock: { alignItems: 'flex-end' },
    amountText: { color: PRIMARY_COLOR, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, marginTop: 4 },
    content: { padding: 20 },
    stack: { gap: 12 },
    stackLarge: { gap: 18 },
    sectionLabel: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 2 },
    ...
    methodCopy: { flex: 1 },
    methodTitle: { color: text, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    methodSubtitle: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', marginTop: 4 },
    backButton: { flexDirection: 'row', alignItems: 'center', gap: 7 },
    backText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
    ...
    providerText: { color: secondary, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', textAlign: 'center' },
    providerTextActive: { color: '#ffffff' },
    inputLabel: { color: secondary, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
    input: { minHeight: 52, borderRadius: 16, borderWidth: 1, borderColor: border, backgroundColor: panelBg, color: text, paddingHorizontal: 14, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
    ...
    bankLabel: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
    bankValue: { color: text, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    accountNumber: { color: PRIMARY_COLOR, ...fontSize.b3, lineHeight: fontSize.b3.fontSize + 2, letterSpacing: 1.6 },
    ...
    walletTitle: { color: text, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase' },
    walletBody: { color: secondary, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    walletHint: { color: muted, ...fontSize.b5, lineHeight: 17, textAlign: 'center' },
    errorText: { color: '#ef4444', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textAlign: 'center', textTransform: 'uppercase' },
    ...
    payButtonText: { color: '#ffffff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
    centerState: { minHeight: 260, alignItems: 'center', justifyContent: 'center', gap: 14 },
    stateTitle: { color: text, ...fontSize.b3, lineHeight: fontSize.b3.fontSize + 2, textTransform: 'uppercase', textAlign: 'center' },
    stateBody: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.4, textAlign: 'center' },
    primaryHint: { color: PRIMARY_COLOR, backgroundColor: primaryColorAlpha(0.08), borderWidth: 1, borderColor: primaryColorAlpha(0.16), paddingHorizontal: 14, paddingVertical: 10, borderRadius: 14, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', textAlign: 'center' },
    successIcon: { width: 82, height: 82, borderRadius: 41, backgroundColor: '#10b981', alignItems: 'center', justifyContent: 'center' },
    successId: { color: '#10b981', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.4 },
    ...
    footerText: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.4 },
  });
};
