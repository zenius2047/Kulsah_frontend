...
const styles = StyleSheet.create({
  ...
  tabText: { color: 'rgba(255,255,255,0.5)', fontSize: FontSize.ten, fontFamily: FontFamily.bold },
  ...
  streakLabel: { color: '#fb923c', fontSize: FontSize.ten, fontFamily: FontFamily.extraBold },
  ...
  railLabel: { color: '#fff', fontSize: FontSize.ten, fontFamily: FontFamily.bold },
  bottom: { paddingHorizontal: 16, paddingBottom: 88, width: '80%' },
  handle: { color: '#fff', fontSize: FontSize.seventeen, fontFamily: FontFamily.extraBold },
  caption: { color: '#fff', marginTop: 4, fontFamily: FontFamily.bold },
  sound: { color: '#cbd5e1', marginTop: 6, fontSize: FontSize.twelve },
  ticket: { color: '#22c55e', marginTop: 6, fontFamily: FontFamily.bold },
  lockOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.55)', justifyContent: 'center', alignItems: 'center', gap: 8 },
  lockTitle: { color: '#fff', fontSize: FontSize.twenty, fontFamily: FontFamily.extraBold },
  ...
  unlockText: { color: '#fff', fontFamily: FontFamily.extraBold, letterSpacing: 1 },
  modalRoot: { flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'flex-end' },
  sheet: { backgroundColor: '#111218', borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 16, maxHeight: '78%' },
  sheetTitle: { color: '#e4e4e7', fontFamily: FontFamily.extraBold, marginBottom: 10 },
  commentRow: { flexDirection: 'row', gap: 8, marginBottom: 10 },
  commentAvatar: { width: 32, height: 32, borderRadius: 16 },
  commentUser: { color: '#fff', fontFamily: FontFamily.bold },
  ...
  postBtn: { color: PRIMARY_COLOR, fontFamily: FontFamily.extraBold, fontSize: FontSize.eleven },
  ...
  promptTitle: { color: '#fff', fontSize: FontSize.twentyOne, fontFamily: FontFamily.extraBold, textAlign: 'center' },
  ...
  promptPrimaryText: { color: '#fff', fontFamily: FontFamily.extraBold, letterSpacing: 1 },
  promptSecondary: { color: '#71717a', textAlign: 'center', marginTop: 10, fontFamily: FontFamily.bold },
});
