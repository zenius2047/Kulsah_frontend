...
const styles = StyleSheet.create({
  ...
  tabText: { color: 'rgba(255,255,255,0.5)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  streakLabel: { color: '#fb923c', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  railLabel: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  bottom: { paddingHorizontal: 16, paddingBottom: 88, width: '80%' },
  handle: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  caption: { color: '#fff', marginTop: 4 },
  sound: { color: '#cbd5e1', marginTop: 6, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
  ticket: { color: '#22c55e', marginTop: 6 },
  lockOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.55)', justifyContent: 'center', alignItems: 'center', gap: 8 },
  lockTitle: { color: '#fff', ...fontSize.b1, lineHeight: fontSize.b1.fontSize + 2 },
  ...
  postBtn: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  footer: { height: 110, justifyContent: 'center', alignItems: 'center', gap: 8 },
  footerText: { color: '#94a3b8', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  promptTitle: { color: '#fff', ...fontSize.b1, lineHeight: fontSize.b1.fontSize + 2, textAlign: 'center' },
  ...
  promptPrimaryText: { color: '#fff', letterSpacing: 1 },
  promptSecondary: { color: '#71717a', textAlign: 'center', marginTop: 10 },
});
