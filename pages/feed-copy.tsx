...
const styles = StyleSheet.create({
  ...
  tabText: { color: 'rgba(255,255,255,0.5)', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  ...
  streakLabel: { color: '#fb923c', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  ...
  railLabel: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  bottom: { paddingHorizontal: 16, paddingBottom: 88, width: '80%' },
  handle: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  caption: { color: '#fff', marginTop: 4 },
  sound: { color: '#cbd5e1', marginTop: 6, ...fontSize.b4, lineHeight: fontSize.b4.lineHeight },
  ...
  lockTitle: { color: '#fff', ...fontSize.b1, lineHeight: fontSize.b1.lineHeight },
  ...
  postBtn: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  footer: { height: 110, justifyContent: 'center', alignItems: 'center', gap: 8 },
  footerText: { color: '#94a3b8', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  ...
  promptTitle: { color: '#fff', ...fontSize.b1, lineHeight: fontSize.b1.lineHeight, textAlign: 'center' },
