...
const styles = StyleSheet.create({
  ...
  headerTitle: { ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase', letterSpacing: 0.8 },
  ...
  tabText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 0.2 },
  ...
  commentHandle: { ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, marginBottom: 5 },
  commentTime: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  commentBody: { ...fontSize.b4,lineHeight: 16 },
  ...
  giftLabel: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 0.6, textTransform: 'uppercase' },
  giftMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 6 },
  giftText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
