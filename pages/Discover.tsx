...
const createStyles = (isDark: boolean) => {
  ...
  return StyleSheet.create({
    ...
    tabText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1.2, textTransform: 'uppercase' },
    ...
    emptyText: { color: muted, ...fontSize.b1, lineHeight: fontSize.b1.fontSize + 2, textAlign: 'center' },
    ...
    liveText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1 },
    proBadge: { position: 'absolute', top: 10, right: 10, color: '#f59e0b', backgroundColor: isDark ? 'rgba(120,53,15,0.32)' : '#fffbeb', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 0.8 },
    ...
    creatorName: { color: text, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1, textTransform: 'uppercase', maxWidth: 120 },
    creatorHandle: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, marginTop: 3, marginBottom: 6 },
    creatorStyle: { color: textSoft, ...fontSize.b5,textAlign: 'center', lineHeight: 15 },
    ...
    followText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1, textTransform: 'uppercase' },
    ...
    ticketCreator: { flex: 1, color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 0.8, textTransform: 'uppercase' },
    ticketTitle: { color: text, ...fontSize.b4,lineHeight: 18, textTransform: 'uppercase' },
    ticketMeta: { color: textSoft, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    ticketVenue: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    ...
    priceLabel: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 0.8, textTransform: 'uppercase' },
    priceText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    ...
    bookButtonText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 0.8, textTransform: 'uppercase' },
    ...
    challengeType: { position: 'absolute', top: 8, left: 8, right: 8, color: text, backgroundColor: isDark ? 'rgba(24,24,27,0.92)' : 'rgba(255,255,255,0.9)', borderRadius: 8, paddingHorizontal: 7, paddingVertical: 3, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    ...
    challengeCreator: { flex: 1, color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    challengeTitle: { color: text, ...fontSize.b4,lineHeight: 18, textTransform: 'uppercase' },
    challengePrize: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    ...
    metricText: { color: textSoft, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    challengeFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 6 },
    joinedText: { flex: 1, color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    ...
    joinText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 0.6, textTransform: 'uppercase' },
    ...
    videoCategory: { position: 'absolute', top: 10, left: 10, color: '#fb7185', backgroundColor: 'rgba(0,0,0,0.55)', borderRadius: 7, paddingHorizontal: 7, paddingVertical: 3, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1, textTransform: 'uppercase' },
    videoDuration: { position: 'absolute', top: 10, right: 10, color: '#fff', backgroundColor: 'rgba(0,0,0,0.6)', borderRadius: 7, paddingHorizontal: 6, paddingVertical: 3, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    ...
    videoCreator: { color: '#fb7185', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1.2, textTransform: 'uppercase' },
    videoTitle: { color: '#fff', ...fontSize.b5,lineHeight: 15, marginTop: 4 },
    viewsRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 5 },
    viewsText: { color: 'rgba(255,255,255,0.78)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    ...
    modalEyebrow: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1.7 },
    ...
    modalTicketInstructor: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 0.7, textTransform: 'uppercase' },
    modalTicketTitle: { color: textSoft, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase', marginTop: 4 },
    modalTicketMeta: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, marginTop: 4 },
    breakdown: { gap: 12 },
    priceRow: { flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, borderColor: border, paddingBottom: 10, gap: 10 },
    priceRowLabel: { flex: 1, color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    priceRowValue: { color: text, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    successText: { color: '#10b981' },
    totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    totalLabel: { color: textSoft, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
    totalValue: { color: PRIMARY_COLOR, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
    ...
    configureText: { color: textSoft, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1, textTransform: 'uppercase' },
    confirmButton: { flex: 1, height: 48, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: PRIMARY_COLOR },
    confirmText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1, textTransform: 'uppercase' },
    ...
    successTitle: { color: text, ...fontSize.b1, lineHeight: fontSize.b1.fontSize + 2, textTransform: 'uppercase' },
    ...
    successButtonText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1, textTransform: 'uppercase' },
    // headerTitle: {
    //     color: '#fff',
