...
const createStyles = (isDark: boolean) => {
  ...
  return StyleSheet.create({
    ...
    statValue: { color: text, ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, marginTop: 6 },
    statLabel: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.1, marginTop: 3, textAlign: 'center' },
    searchBox: { height: 48, borderRadius: 18, borderWidth: 1, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 14 },
    searchInput: { flex: 1, ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, paddingVertical: 0 },
    ...
    segmentText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    emptyText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
    resetText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.2 },
    listStack: { gap: 14 },
    ...
    metricMiniText: { color: isDark ? '#d4d4d8' : '#475569', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
    actionColumn: { gap: 7 },
    ...
    gridUserName: { color: '#fff', flex: 1, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 0.8 },
    gridTitle: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase' },
    gridMeta: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
    gridMetaText: { color: 'rgba(255,255,255,0.55)', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase' },
    gridLikes: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase' },
    ...
    gridActionText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 0.6 },
    ...
    playerUserName: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    hudChallenge: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
    hudTitle: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, textTransform: 'uppercase', marginTop: 4 },
    ...
    reviewButtonText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    rewardButtonText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.5 },
  });
};
