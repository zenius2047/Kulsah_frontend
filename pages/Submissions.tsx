...
const createStyles = (isDark: boolean) => {
  ...
  return StyleSheet.create({
    ...
    headerTitle: { ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase', letterSpacing: 2.2 },
    headerSubtitle: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    toastText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textAlign: 'center', textTransform: 'uppercase', letterSpacing: 1.1 },
    ...
    statValue: { color: text, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, marginTop: 6 },
    statLabel: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.1, marginTop: 3, textAlign: 'center' },
    ...
    clearText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    ...
    segmentText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    emptyText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
    resetText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
    listStack: { gap: 14 },
    ...
    userName: { color: text, flexShrink: 1, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 0.8 },
    userHandle: { color: muted, flexShrink: 1, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    submissionTitle: { color: text, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    metaRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    submittedAt: { color: muted, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 0.8 },
    shortlistPill: { color: '#f59e0b', borderWidth: 1, borderColor: 'rgba(245,158,11,0.22)', backgroundColor: 'rgba(245,158,11,0.1)', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 5, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    ...
    metricMiniText: { color: isDark ? '#d4d4d8' : '#475569', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
    actionColumn: { gap: 7 },
    ...
    gridUserName: { color: '#fff', flex: 1, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 0.8 },
    gridTitle: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    gridMeta: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
    gridMetaText: { color: 'rgba(255,255,255,0.55)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    gridLikes: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
    ...
    gridActionText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 0.6 },
    ...
    playerUserName: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    hudChallenge: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
    hudTitle: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase', marginTop: 4 },
    ...
    reviewButtonText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    rewardButtonText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.5 },
  });
};
