...
const styles = StyleSheet.create({
  safeArea: { flex: 1 }, toast: { position: 'absolute', left: 24, right: 24, zIndex: 40, alignItems: 'center' }, toastText: { color: '#fff', fontFamily: 'PlusJakartaSansExtraBold', fontSize: FontSize.eight, textTransform: 'uppercase', letterSpacing: 1.6, backgroundColor: '#cd2bee', paddingHorizontal: 18, paddingVertical: 10, borderRadius: 999 },
