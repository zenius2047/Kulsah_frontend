...
const styles = StyleSheet.create({
  safeArea: { flex: 1 }, toast: { position: 'absolute', left: 24, right: 24, zIndex: 40, alignItems: 'center' }, toastText: { color: '#fff', fontFamily: FontFamily.extraBold, fontSize: FontSize.eight, textTransform: 'uppercase', letterSpacing: 1.6, backgroundColor: PRIMARY_COLOR, paddingHorizontal: 18, paddingVertical: 10, borderRadius: 999 },
  header: { position: 'absolute', top: 0, left: 0, right: 0, zIndex: 20, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, headerActions: { flexDirection: 'row', alignItems: 'center', gap: 10 }, iconBtn: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', borderWidth: 1 }, pill: { flexDirection: 'row', alignItems: 'center', gap: 8, height: 42, paddingHorizontal: 14, borderRadius: 999, borderWidth: 1 }, pillSmall: { height: 42, minWidth: 62, borderRadius: 999, borderWidth: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 14 }, pillText: { fontFamily: FontFamily.extraBold, fontSize: FontSize.eight, textTransform: 'uppercase', letterSpacing: 0.8 },
  videoShell: { marginHorizontal: 12, borderRadius: 30, overflow: 'hidden', borderWidth: 1, aspectRatio: 16 / 9, backgroundColor: '#000' }, video: { ...StyleSheet.absoluteFillObject }, heatmap: { position: 'absolute', bottom: 60, left: 16, right: 16, height: 52, flexDirection: 'row', alignItems: 'flex-end', gap: 2 }, heatBar: { flex: 1, borderTopLeftRadius: 4, borderTopRightRadius: 4 }, controls: { ...StyleSheet.absoluteFillObject, justifyContent: 'center', alignItems: 'center' }, controlsRow: { flexDirection: 'row', alignItems: 'center', gap: 20 }, ghostBtn: { width: 52, height: 52, borderRadius: 26, backgroundColor: 'rgba(255,255,255,0.12)', alignItems: 'center', justifyContent: 'center' }, playBtn: { width: 82, height: 82, borderRadius: 41, backgroundColor: primaryColorAlpha(0.22), borderWidth: 1, borderColor: primaryColorAlpha(0.4), alignItems: 'center', justifyContent: 'center' }, muteBtn: { position: 'absolute', right: 18, bottom: 72, width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(0,0,0,0.45)', alignItems: 'center', justifyContent: 'center' }, videoFooter: { position: 'absolute', left: 16, right: 16, bottom: 16 }, track: { height: 4, borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.24)', overflow: 'hidden' }, fill: { height: '100%', borderRadius: 999, backgroundColor: PRIMARY_COLOR }, metaRow: { marginTop: 10, flexDirection: 'row', justifyContent: 'space-between' }, metaText: { color: 'rgba(255,255,255,0.8)', fontFamily: FontFamily.bold, fontSize: FontSize.eight, textTransform: 'uppercase', letterSpacing: 0.8 },
  sectionStack: { paddingHorizontal: 16, paddingTop: 22, gap: 22 }, statGrid: { flexDirection: 'row', gap: 10 }, statCard: { flex: 1, borderRadius: 24, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 16, alignItems: 'center', gap: 6 }, statValue: { fontFamily: FontFamily.extraBold, fontSize: FontSize.twelve }, statLabel: { fontFamily: FontFamily.extraBold, fontSize: FontSize.six, textTransform: 'uppercase', letterSpacing: 1.1 },
  rowBetween: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, panel: { borderRadius: 28, borderWidth: 1, padding: 18, gap: 16 }, eyebrow: { fontFamily: FontFamily.extraBold, fontSize: FontSize.seven, textTransform: 'uppercase', letterSpacing: 1.5 }, syncDot: { width: 16, height: 16, borderRadius: 8, borderWidth: 2 }, protocolRow: { flexDirection: 'row', gap: 12 }, protocolCard: { flex: 1, borderRadius: 22, borderWidth: 1, padding: 16, gap: 10 }, protocolTitle: { fontFamily: FontFamily.bold, fontSize: FontSize.ten }, protocolCopy: { fontFamily: FontFamily.bold, fontSize: FontSize.eight, textTransform: 'uppercase' },
  auditPanel: { borderRadius: 30, borderWidth: 1, padding: 18, gap: 14 }, auditHead: { flexDirection: 'row', alignItems: 'center', gap: 12 }, auditIcon: { width: 42, height: 42, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: primaryColorAlpha(0.10) }, auditTitle: { fontFamily: FontFamily.extraBold, fontSize: FontSize.eight, textTransform: 'uppercase', letterSpacing: 1.3 }, auditSub: { fontFamily: FontFamily.bold, fontSize: FontSize.six, textTransform: 'uppercase' }, auditButton: { height: 46, borderRadius: 18, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, auditButtonText: { fontFamily: FontFamily.extraBold, fontSize: FontSize.eight, textTransform: 'uppercase' },
  titleBlock: { gap: 8 }, title: { fontFamily: FontFamily.extraBold, fontSize: FontSize.twenty }, titleMeta: { flexDirection: 'row', alignItems: 'center', gap: 8 }, smallMeta: { fontFamily: FontFamily.bold, fontSize: FontSize.eight, textTransform: 'uppercase', letterSpacing: 1 }, dot: { width: 4, height: 4, borderRadius: 2 }, actionRow: { gap: 10 }, actionChip: { flexDirection: 'row', alignItems: 'center', gap: 8, height: 44, paddingHorizontal: 16, borderRadius: 18, borderWidth: 1 }, actionText: { fontFamily: FontFamily.extraBold, fontSize: FontSize.seven, textTransform: 'uppercase', letterSpacing: 1 },
  artistMain: { flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1 }, artistAvatar: { width: 54, height: 54, borderRadius: 18 }, artistRow: { flexDirection: 'row', alignItems: 'center', gap: 6 }, artistName: { fontFamily: FontFamily.bold, fontSize: FontSize.twelve }, artistHandle: { fontFamily: FontFamily.extraBold, fontSize: FontSize.eight, textTransform: 'uppercase', letterSpacing: 1 }, followButton: { height: 42, borderRadius: 16, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'center' }, followText: { color: '#fff', fontFamily: FontFamily.extraBold, fontSize: FontSize.eight, textTransform: 'uppercase', letterSpacing: 1.2 },
  copyBlock: { gap: 8 }, body: { fontFamily: FontFamily.medium, fontSize: FontSize.eleven, lineHeight: 20 }, commentsBlock: { gap: 14 }, sectionTitle: { fontFamily: FontFamily.extraBold, fontSize: FontSize.eighteen }, commentComposer: { borderRadius: 24, borderWidth: 1, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 6 }, commentInput: { flex: 1, minHeight: 46, fontFamily: FontFamily.medium, fontSize: FontSize.eleven }, commentRow: { flexDirection: 'row', gap: 12 }, commentAvatar: { width: 42, height: 42, borderRadius: 14 }, commentUser: { fontFamily: FontFamily.bold, fontSize: FontSize.ten }, commentBody: { marginTop: 4, fontFamily: FontFamily.medium, fontSize: FontSize.ten, lineHeight: 18 },
  queueHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: 10 }, queueBadge: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 5 }, queueBadgeText: { color: '#fff', fontFamily: FontFamily.extraBold, fontSize: FontSize.six, textTransform: 'uppercase' }, manageButton: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 16, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 10 }, upNextRow: { flexDirection: 'row', gap: 14 }, thumbWrap: { width: 156, aspectRatio: 16 / 9, borderRadius: 24, overflow: 'hidden' }, thumb: { width: '100%', height: '100%' }, nextBadge: { position: 'absolute', top: 10, left: 10, borderRadius: 10, paddingHorizontal: 8, paddingVertical: 4 }, nextBadgeText: { color: '#fff', fontFamily: FontFamily.extraBold, fontSize: FontSize.six, textTransform: 'uppercase' }, durationBadge: { position: 'absolute', right: 10, bottom: 10, backgroundColor: 'rgba(0,0,0,0.7)', borderRadius: 8, paddingHorizontal: 6, paddingVertical: 3 }, durationText: { color: '#fff', fontFamily: FontFamily.bold, fontSize: FontSize.seven }, upNextCopy: { flex: 1, justifyContent: 'space-between', paddingVertical: 4 }, upNextTitle: { fontFamily: FontFamily.extraBold, fontSize: FontSize.eleven, lineHeight: 18 }, queueButton: { height: 34, borderRadius: 12, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingHorizontal: 12, alignSelf: 'flex-start' },
  modalRoot: { flex: 1, justifyContent: 'flex-end' }, modalBackdrop: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.6)' }, queueSheet: { borderTopLeftRadius: 36, borderTopRightRadius: 36, borderWidth: 1, paddingTop: 10, paddingHorizontal: 18, maxHeight: '82%' }, sheetHandle: { width: 44, height: 5, borderRadius: 999, alignSelf: 'center', marginBottom: 18 }, queueRow: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14, borderRadius: 22, borderWidth: 1 }, queueThumb: { width: 58, height: 58, borderRadius: 16 }, queueTitle: { fontFamily: FontFamily.bold, fontSize: FontSize.ten }, emptyQueue: { alignItems: 'center', justifyContent: 'center', paddingVertical: 44, gap: 10 }, queueFooter: { flexDirection: 'row', gap: 10 }, clearButton: { flex: 1, height: 50, borderRadius: 18, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, playNextButton: { flex: 1.5, height: 50, borderRadius: 18, alignItems: 'center', justifyContent: 'center' },
});
