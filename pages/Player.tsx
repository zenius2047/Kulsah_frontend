          ...
          {studioMode ? (
            ...
            <>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.actionRow}>
                <Pressable onPress={() => setLiked((v) => !v)} style={[styles.actionChip, { backgroundColor: liked ? 'rgba(244,63,94,0.14)' : soft, borderColor: liked ? '#f43f5e' : border }]}><MaterialIcons name={liked ? 'favorite' : 'favorite-border'} size={18} color={liked ? '#f43f5e' : theme.text} /><Text style={[styles.actionText, { color: liked ? '#f43f5e' : theme.text }]}>12k</Text></Pressable>
...
const styles = StyleSheet.create({
  ...
  titleBlock: { gap: 8 }, title: { ...fontSize.b1, lineHeight: fontSize.b1.lineHeight }, titleMeta: { flexDirection: 'row', alignItems: 'center', gap: 8 }, smallMeta: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 }, dot: { width: 4, height: 4, borderRadius: 2 }, actionRow: { gap: 10 }, actionChip: { flexDirection: 'row', alignItems: 'center', gap: 8, height: 44, paddingHorizontal: 16, borderRadius: 18, borderWidth: 1 }, actionText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
  artistMain: { flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1 }, artistAvatar: { width: 54, height: 54, borderRadius: 18 }, artistRow: { flexDirection: 'row', alignItems: 'center', gap: 6 }, artistName: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight }, artistHandle: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 }, followButton: { height: 42, borderRadius: 16, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'center' }, followText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.2 },
  copyBlock: { gap: 8 }, body: { ...fontSize.b5, lineHeight: 20 }, commentsBlock: { gap: 14 }, sectionTitle: { ...fontSize.b1, lineHeight: fontSize.b1.lineHeight }, commentComposer: { borderRadius: 24, borderWidth: 1, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 6 }, commentInput: { flex: 1, minHeight: 46, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight }, commentRow: { flexDirection: 'row', gap: 12 }, commentAvatar: { width: 42, height: 42, borderRadius: 14 }, commentUser: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight }, commentBody: { marginTop: 4, ...fontSize.b5, lineHeight: 18 },
  queueHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: 10 }, queueBadge: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 5 }, queueBadgeText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase' }, manageButton: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 16, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 10 }, upNextRow: { flexDirection: 'row', gap: 14 }, thumbWrap: { width: 156, aspectRatio: 16 / 9, borderRadius: 24, overflow: 'hidden' }, thumb: { width: '100%', height: '100%' }, nextBadge: { position: 'absolute', top: 10, left: 10, borderRadius: 10, paddingHorizontal: 8, paddingVertical: 4 }, nextBadgeText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase' }, durationBadge: { position: 'absolute', right: 10, bottom: 10, backgroundColor: 'rgba(0,0,0,0.7)', borderRadius: 8, paddingHorizontal: 6, paddingVertical: 3 }, durationText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight }, upNextCopy: { flex: 1, justifyContent: 'space-between', paddingVertical: 4 }, upNextTitle: { ...fontSize.b5, lineHeight: 18 }, queueButton: { height: 34, borderRadius: 12, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingHorizontal: 12, alignSelf: 'flex-start' },
