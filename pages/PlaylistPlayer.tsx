      ...
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingTop: insets.top + 74, paddingBottom: 120 }}>
        ...
        <View style={styles.content}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.actionRow}>
            <Pressable onPress={() => setIsLiked((value) => !value)} style={[styles.actionChip, { backgroundColor: isLiked ? primaryColorAlpha(0.16) : soft, borderColor: isLiked ? PRIMARY_COLOR : border }]}><MaterialIcons name={isLiked ? 'favorite' : 'favorite-border'} size={18} color={isLiked ? PRIMARY_COLOR : theme.text} /><Text style={[styles.actionText, { color: isLiked ? PRIMARY_COLOR : theme.text }]}>Like</Text></Pressable>
