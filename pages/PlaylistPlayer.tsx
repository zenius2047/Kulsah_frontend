...
const styles = StyleSheet.create({
  ...
  toastText: { color: '#fff', backgroundColor: PRIMARY_COLOR, paddingHorizontal: 18, paddingVertical: 9, borderRadius: 999, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.4, overflow: 'hidden' },
  ...
  headerEyebrow: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 2 },
  headerTitle: { ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, textTransform: 'uppercase' },
  ...
  lockTitle: { color: '#fff', ...fontSize.b2, lineHeight: fontSize.b2.lineHeight, textTransform: 'uppercase', textAlign: 'center' },
  lockCopy: { color: '#a1a1aa', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textAlign: 'center', maxWidth: 300 },
  joinButton: { marginTop: 4, backgroundColor: PRIMARY_COLOR, borderRadius: 18, paddingHorizontal: 18, paddingVertical: 10 },
  joinText: { color: '#000', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.2 },
  content: { padding: 16, gap: 18 },
  titleBlock: { gap: 8 },
  title: { ...fontSize.b1, lineHeight: fontSize.b1.lineHeight, textTransform: 'uppercase' },
  metaRow: { flexDirection: 'row', alignItems: 'center', gap: 8, flexWrap: 'wrap' },
  trackBadge: { color: PRIMARY_COLOR, backgroundColor: primaryColorAlpha(0.14), borderColor: primaryColorAlpha(0.24), borderWidth: 1, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
  metaText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase' },
  ...
  actionText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
  ...
  artistName: { ...fontSize.b4, lineHeight: fontSize.b4.lineHeight },
  artistHandle: { color: '#cca514', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.3 },
  ...
  followText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.2 },
  auditPanel: { borderRadius: 24, borderWidth: 1, padding: 16, gap: 12 },
  rowBetween: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 },
  sectionTitle: { ...fontSize.b3, lineHeight: fontSize.b3.lineHeight, textTransform: 'uppercase' },
  auditCopy: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  ...
  auditButtonText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1 },
  section: { gap: 10 },
  orderText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.2 },
  ...
  indexText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  ...
  trackTitle: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  trackMeta: { marginTop: 2, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  ...
  input: { flex: 1, minHeight: 44, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  sendText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.2 },
  commentRow: { flexDirection: 'row', gap: 12 },
  commentAvatar: { width: 38, height: 38, borderRadius: 19 },
  commentUser: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 0.8 },
  commentTime: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase' },
  commentBody: { marginTop: 4, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
