...
const styles = StyleSheet.create({
  safeArea: { flex: 1 }, toastWrap: { position: 'absolute', left: 20, right: 20, zIndex: 50, alignItems: 'center' }, toastText: { color: '#fff', backgroundColor: PRIMARY_COLOR, paddingHorizontal: 18, paddingVertical: 10, borderRadius: 999, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.4 },
  ...
  content: { paddingHorizontal: 16, gap: 22 }, panel: { borderRadius: 28, borderWidth: 1, padding: 18, gap: 18 }, rowBetween: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, eyebrowAccent: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.8 }, title: { ...fontSize.b1, lineHeight: mediumScreen ? 28 : 22 }, fastBadge: { backgroundColor: 'rgba(239,68,68,0.12)', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, borderWidth: 1, borderColor: 'rgba(239,68,68,0.22)' }, fastBadgeText: { color: '#ef4444', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
  infoBlock: { borderTopWidth: 1, borderBottomWidth: 1, paddingVertical: 16, gap: 14 }, infoRow: { flexDirection: 'row', alignItems: 'center', gap: 12 }, infoIcon: { width: 42, height: 42, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, infoTitle: { ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 }, infoSub: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  liveBadgeText: { color: '#22c55e', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
  ...
  statLabel: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.1 },
  statValueLarge: { marginTop: 6, ...fontSize.b1, lineHeight: fontSize.b1.fontSize + 2 },
  statValue: { marginTop: 6, ...fontSize.b3, lineHeight: fontSize.b3.fontSize + 2, textTransform: 'uppercase' },
  statMeta: { marginTop: 3, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  performanceLabel: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
  performanceMeta: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  sectionGap: { gap: 12 }, eyebrow: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.6 }, spinner: { width: 16, height: 16, borderRadius: 8, borderWidth: 2 }, mapCard: { aspectRatio: 16 / 9, borderRadius: 22, overflow: 'hidden', borderWidth: 1 }, mapImage: { width: '100%', height: '100%' }, mapOverlay: { ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center', gap: 6 }, mapText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
  tipCard: { borderRadius: 22, borderWidth: 1, padding: 16, gap: 12 }, body: { ...fontSize.b4, lineHeight: mediumScreen ? 24 : 20 }, tipRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 }, tipText: { flex: 1, ...fontSize.b5, lineHeight: mediumScreen ? 20 : 16 }, routeButton: { height: 46, borderRadius: 22, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8 }, routeButtonText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
  sectionTitle: { ...fontSize.b1, lineHeight: fontSize.b1.fontSize + 2 }, ticketRow: { borderWidth: 1, borderRadius: 20, padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10 }, ticketTitle: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 }, ticketMeta: { marginTop: 4, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 0.6 }, ticketPrice: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  footer: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingHorizontal: 16, paddingTop: 14, borderTopWidth: 1 }, footerButton: { height: 58, borderRadius: 28, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8 }, footerButtonText: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
  modalRoot: { flex: 1, justifyContent: 'flex-end' }, modalBackdrop: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.68)' }, modalCard: { borderTopLeftRadius: 34, borderTopRightRadius: 34, borderWidth: 1, paddingHorizontal: 18, paddingTop: 10, gap: 12 }, sheetHandle: { width: 46, height: 5, borderRadius: 999, alignSelf: 'center', marginBottom: 6 }, centerBlock: { alignItems: 'center', gap: 6, marginBottom: 8 }, reminderRow: { height: 52, borderRadius: 18, borderWidth: 1, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, reminderText: { ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 }, removeButton: { height: 48, borderRadius: 18, alignItems: 'center', justifyContent: 'center' }, removeButtonText: { color: '#ef4444', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 }, cancelButton: { height: 50, borderRadius: 18, borderWidth: 1, alignItems: 'center', justifyContent: 'center', marginTop: 4 },
});
