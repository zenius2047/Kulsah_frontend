...
const styles = StyleSheet.create({
  ...
  liveBadgeText: { color: '#22c55e', fontFamily: 'PlusJakartaSansExtraBold', fontSize: mediumScreen ? FontSize.nine : FontSize.seven, textTransform: 'uppercase', letterSpacing: 1 },
  ...
  statLabel: { fontFamily: 'PlusJakartaSansExtraBold', fontSize: mediumScreen ? FontSize.nine : FontSize.seven, textTransform: 'uppercase', letterSpacing: 1.1 },
