...
const styles = StyleSheet.create({
  ...
  tipCard: { borderRadius: 22, borderWidth: 1, padding: 16, gap: 12 }, body: { fontFamily: 'PlusJakartaSansMedium', fontSize: fontScale(11), lineHeight: 20 }, tipRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 }, tipText: { flex: 1, fontFamily: 'PlusJakartaSansMedium', fontSize: fontScale(9), lineHeight: 16 }, routeButton: { height: 46, borderRadius: 16, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8 }, routeButtonText: { color: '#fff', fontFamily: 'PlusJakartaSansExtraBold', fontSize: fontScale(8), textTransform: 'uppercase', letterSpacing: 1.2 },
  sectionTitle: { fontFamily: 'PlusJakartaSansExtraBold', fontSize: fontScale(18) }, ticketRow: { borderWidth: 1, borderRadius: 20, padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10 }, ticketTitle: { fontFamily: 'PlusJakartaSansBold', fontSize: fontScale(11) }, ticketMeta: { marginTop: 4, fontFamily: 'PlusJakartaSansMedium', fontSize: fontScale(8), textTransform: 'uppercase', letterSpacing: 0.6 }, ticketPrice: { fontFamily: 'PlusJakartaSansExtraBold', fontSize: fontScale(11) },
  footer: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingHorizontal: 16, paddingTop: 14, borderTopWidth: 1 }, footerButton: { height: 58, borderRadius: 20, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8 }, footerButtonText: { color: '#fff', fontFamily: 'PlusJakartaSansExtraBold', fontSize: fontScale(10), textTransform: 'uppercase', letterSpacing: 1.2 },
