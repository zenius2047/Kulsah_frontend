...
const s = StyleSheet.create({
  ...
  headerTitle: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, fontWeight: '900', textTransform: 'uppercase' },
  headerSub: { color: '#8f95af', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, fontWeight: '800', textTransform: 'uppercase' },
  stepLabel: { marginLeft: 'auto', color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, fontWeight: '900', textTransform: 'uppercase' },
  content: { padding: 16, paddingBottom: 180, gap: 12 },
  sectionTitle: { color: '#8f95af', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.6 },
  ...
  stageText: { color: '#8f95af', fontWeight: '900', letterSpacing: 3, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  ...
  zoneText: { color: '#fff', fontWeight: '900', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, letterSpacing: 1.2 },
  ...
  aiTitle: { color: PRIMARY_COLOR, fontWeight: '900', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', letterSpacing: 1.8 },
  aiBody: { color: '#d9dce9', ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, fontStyle: 'italic' },
  ...
  aiButtonText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, fontWeight: '900', textTransform: 'uppercase' },
  ...
  tierName: { color: '#fff', fontWeight: '900', ...fontSize.b4, lineHeight: fontSize.b4.lineHeight },
  tierDesc: { color: '#8f95af', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, marginTop: 2 },
  price: { ...fontSize.b1, lineHeight: fontSize.b1.lineHeight, fontWeight: '900' },
  badge: { color: '#8f95af', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', fontWeight: '900' },
  ...
  qtyText: { color: '#fff', fontWeight: '900', minWidth: 18, textAlign: 'center', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  ...
  totalLabel: { color: '#8f95af', ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, textTransform: 'uppercase', fontWeight: '900' },
  totalPrice: { color: '#fff', ...fontSize.b1, lineHeight: fontSize.b1.lineHeight, fontWeight: '900' },
  totalTickets: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, fontWeight: '900', textTransform: 'uppercase' },
  ...
  primaryButtonText: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.2 },
  ...
  successTitle: { color: '#fff', ...fontSize.b1, lineHeight: fontSize.b1.lineHeight, fontWeight: '900', textTransform: 'uppercase' },
  successBody: { color: '#a5abc0', textAlign: 'center', ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, maxWidth: 280 },
