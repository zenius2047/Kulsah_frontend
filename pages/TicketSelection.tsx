...
const s = StyleSheet.create({
  ...
  sectionTitle: { color: '#8f95af', fontSize: fontScale(9), fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.6 },
  ...
  aiTitle: { color: '#cd2bee', fontWeight: '900', fontSize: fontScale(9), textTransform: 'uppercase', letterSpacing: 1.8 },
  ...
  tierName: { color: '#fff', fontWeight: '900', fontSize: fontScale(14) },
  ...
  successTitle: { color: '#fff', fontSize: fontScale(25), fontWeight: '900', textTransform: 'uppercase' },
