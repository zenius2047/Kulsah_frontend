...
const styles = StyleSheet.create({
  ...
  headerTitle: { ...fontSize.b3, lineHeight: fontSize.b3.lineHeight },
  readyPill: {
    borderRadius: 999,
  ...
  readyText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, letterSpacing: 1.2 },
  ...
  stepLabel: { ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, letterSpacing: 1 },
  stepLabelActive: { color: PRIMARY_COLOR },
  body: { flex: 1 },
  bodyContent: { paddingHorizontal: 16, paddingTop: 16, paddingBottom: 220, gap: 18 },
  sectionWrap: { gap: 22 },
  section: { gap: 10 },
  sectionLabel: { ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, letterSpacing: 1.6 },
  previewCard: {
    height: 210,
    borderRadius: 28,
    overflow: 'hidden',
  ...
  qualityLabel: { ...fontSize.b3, lineHeight: fontSize.b3.lineHeight },
  qualityBitrate: { ...fontSize.b4, lineHeight: fontSize.b4.lineHeight },
  qualityTextActive: { color: '#fff' },
  helperText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  titleInput: {
    height: 58,
    borderRadius: 16,
    borderWidth: 1,
  ...
  vibeText: { ...fontSize.b4, lineHeight: fontSize.b4.lineHeight, letterSpacing: 0.8 },
  ...
  protocolTitle: { ...fontSize.b3, lineHeight: fontSize.b3.lineHeight },
  protocolSub: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  notifyRow: {
    borderRadius: 16,
    borderWidth: 1,
    borderColor: 'rgba(255,255,255,0.1)',
  ...
  notifyTitle: { ...fontSize.b4, lineHeight: fontSize.b4.lineHeight },
  notifySub: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, marginTop: 2 },
  footer: {
    position: 'absolute',
    left: 0,
    right: 0,
  ...
  progressText: { ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  progressValue: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight },
  progressTrack: {
    height: 8,
    borderRadius: 5,
    borderWidth: 1,
