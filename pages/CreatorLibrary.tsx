...
const s = StyleSheet.create({
  ...
  title: { color: '#fff', fontSize: fontScale(16), fontFamily: 'PlusJakartaSansExtraBold', textTransform: 'uppercase' },
  ...
  aiTitle: { color: '#cd2bee', textTransform: 'uppercase', fontWeight: '900', fontSize: fontScale(9) },
  ...
  itemTitle: { color: '#fff', fontFamily: 'PlusJakartaSansExtraBold', flex: 1, marginRight: 8, lineHeight: 10, fontSize: fontScale(11) },
  ...
  drawerTitle: { color: '#fff', textTransform: 'uppercase', fontWeight: '900', fontSize: fontScale(18) },
