...
const styles = StyleSheet.create({
  ...
  searchAction: { color: PRIMARY_COLOR, ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
  ...
  tabText: { color: 'rgba(255,255,255,0.42)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  sectionTitle: { color: 'rgba(255,255,255,0.62)', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, marginBottom: 18 },
  clearText: { color: 'rgba(255,255,255,0.24)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase' },
  ...
  recentHandle: { width: 68, textAlign: 'center', color: 'rgba(255,255,255,0.42)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  trendingList: { gap: 21 },
  ...
  rank: { width: 22, color: 'rgba(255,255,255,0.24)', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
  rankHot: { color: PRIMARY_COLOR },
  trendTag: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase' },
  trendMeta: { color: 'rgba(255,255,255,0.25)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  creatorName: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase' },
  creatorFollowers: { marginTop: 5, color: 'rgba(255,255,255,0.45)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1.6 },
  resultsStack: { gap: 28 },
  stackSmall: { gap: 12 },
  kicker: { color: 'rgba(255,255,255,0.42)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.4 },
  inlineAction: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
  ...
  userName: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
  userMeta: { marginTop: 2, color: 'rgba(255,255,255,0.42)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  userFollowers: { marginTop: 5, color: 'rgba(255,255,255,0.24)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.1 },
  ...
  followText: { color: '#0f172a', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1 },
  ...
  viewsText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  videoTitle: { marginTop: 8, color: 'rgba(255,255,255,0.92)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  authorText: { color: 'rgba(255,255,255,0.42)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  ...
  keywordText: { flex: 1, color: 'rgba(255,255,255,0.66)', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
  ...
  soundTitle: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1 },
  ...
  liveBadgeText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1, letterSpacing: 1 },
  ...
  viewerText: { color: '#fff', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  liveBottom: { position: 'absolute', left: 14, right: 14, bottom: 16 },
  liveTitle: { color: '#fff', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, marginBottom: 7 },
  ...
  liveUser: { color: 'rgba(255,255,255,0.65)', ...fontSize.b5, lineHeight: fontSize.b5.fontSize + 1 },
  emptyState: { alignItems: 'center', justifyContent: 'center', paddingVertical: 80 },
  emptyText: { marginTop: 12, color: 'rgba(255,255,255,0.28)', ...fontSize.b4, lineHeight: fontSize.b4.fontSize + 1, textTransform: 'uppercase', letterSpacing: 1.2 },
});
