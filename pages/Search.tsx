...
const styles = StyleSheet.create({
  ...
  clearText: { color: 'rgba(255,255,255,0.24)', fontSize: FontSize.nine, fontFamily: 'PlusJakartaSansExtraBold', textTransform: 'uppercase' },
  ...
  recentHandle: { width: 68, textAlign: 'center', color: 'rgba(255,255,255,0.42)', fontSize: FontSize.nine, fontFamily: 'PlusJakartaSansBold' },
  trendingList: { gap: 21 },
  ...
  creatorName: { color: '#fff', fontSize: FontSize.sixteen, fontFamily: 'PlusJakartaSansExtraBold', textTransform: 'uppercase' },
  creatorFollowers: { marginTop: 5, color: 'rgba(255,255,255,0.45)', fontSize: FontSize.eight, fontFamily: 'PlusJakartaSansExtraBold', letterSpacing: 1.6 },
  resultsStack: { gap: 28 },
  stackSmall: { gap: 12 },
  ...
  userName: { color: '#fff', fontSize: FontSize.fourteen, fontFamily: 'PlusJakartaSansExtraBold' },
  ...
  keywordText: { flex: 1, color: 'rgba(255,255,255,0.66)', fontSize: FontSize.thirteen, fontFamily: 'PlusJakartaSansBold' },
  ...
  soundTitle: { color: '#fff', fontSize: FontSize.thirteen, fontFamily: 'PlusJakartaSansExtraBold' },
  ...
  liveBadgeText: { color: '#fff', fontSize: FontSize.eight, fontFamily: 'PlusJakartaSansExtraBold', letterSpacing: 1 },
