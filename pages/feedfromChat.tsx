...
const styles = StyleSheet.create({
  ...
  railText: { color: "white", fontSize: FontSize.twelve, fontWeight: "700", marginTop: 4 },
  bottomMeta: { position: "absolute", left: 14, right: 80, bottom: 56 },
  handleRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  handleText: { color: "white", fontWeight: "800", fontSize: FontSize.fourteen },
  premiumPill: {
    borderRadius: 8,
    borderWidth: 1,
  ...
  premiumText: { color: "#22c55e", fontSize: FontSize.nine, fontWeight: "800" },
  caption: { color: "white", marginTop: 8, fontSize: FontSize.thirteen, fontWeight: "600", lineHeight: 18 },
  ticketBtn: {
    marginTop: 10,
    backgroundColor: "#22c55e",
  ...
  commentHeaderText: { color: "white", fontWeight: "700", fontSize: FontSize.sixteen },
  ...
  tabText: { color: "#94a3b8", fontSize: FontSize.eleven, fontWeight: "800" },
