...
const createStyles = (isDark: boolean, theme: ReturnType<typeof useThemeMode>['theme']) => {
  ...
  headerTitle: { color: titleText, ...fontSize.h1, lineHeight: fontSize.h1.lineHeight, textTransform: 'uppercase', letterSpacing: 2 },
  toast: {
    position: 'absolute',
    top: 52,
    left: 16,
  ...
  congratsText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, letterSpacing: 3 },
  heroCopy: { alignItems: 'center', marginTop: 18 },
  heroSmall: { color: titleText, ...fontSize.b1, lineHeight: fontSize.b1.lineHeight, letterSpacing: 1.2 },
  ...
  rewardLabel: { color: mutedText, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, marginTop: 8, letterSpacing: 1 },
  rewardValue: { color: titleText, ...fontSize.b2, lineHeight: fontSize.b2.lineHeight, marginTop: 4, textAlign: 'center' },
  claimBtn: {
    width: '100%',
    marginTop: 18,
    height: 58,
  ...
  claimBtnText: { color: '#fff', ...fontSize.b3, lineHeight: fontSize.b3.lineHeight, letterSpacing: 1.4 },
  sectionTitle: { alignSelf: 'flex-start', color: mutedText, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, letterSpacing: 2, marginTop: 28, marginBottom: 12 },
  ...
  registryCopy: { flex: 1 },
  registryTitle: { color: titleText, ...fontSize.b4, lineHeight: fontSize.b4.lineHeight },
  registryMeta: { color: secondaryText, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, marginTop: 4 },
  ...
  statusText: { color: PRIMARY_COLOR, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, letterSpacing: 0.8 },
  ...
  sizeText: { color: secondaryText, ...fontSize.b4, lineHeight: fontSize.b4.lineHeight },
  ...
  methodTitle: { color: titleText, ...fontSize.b4, lineHeight: fontSize.b4.lineHeight },
  methodTitleActive: { color: '#fff' },
  methodBody: { color: secondaryText, ...fontSize.b5, lineHeight: fontSize.b5.lineHeight, marginTop: 2 },
  ...
  codeText: { color: titleText, ...fontSize.b3, lineHeight: fontSize.b3.lineHeight, letterSpacing: 1.2, marginTop: 6 },
  });
};
